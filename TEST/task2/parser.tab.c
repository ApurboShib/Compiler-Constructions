...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PLUS_ASSIGN = 16,               /* PLUS_ASSIGN  */
  YYSYMBOL_LE = 17,                        /* LE  */
  YYSYMBOL_GE = 18,                        /* GE  */
  ...
  YYSYMBOL_DIV = 28,                       /* DIV  */
  YYSYMBOL_MOD = 29,                       /* MOD  */
  YYSYMBOL_AMPERSAND = 30,                 /* AMPERSAND  */
...
{
       0,    63,    63,    65,    69,    70,    71,    72,    73,    74,
      74,    74,    74,    74,    74,    75,    81,    81,    81,    81,
...
static const char *const yytname[] =
{
  ...
  "INT", "FLOAT", "CHAR", "FOR", "IF", "ELSE", "RETURN", "PRINTF", "SCANF",
  "MAIN", "ASSIGN", "PLUS_ASSIGN", "LE", "GE", "LESS", "GREATER", "EQ",
  "NE", "AND", "INC", "PLUS", "MINUS", "MUL", "DIV", "MOD", "AMPERSAND",
  "QUESTION", "COLON", "COMMA", "SEMICOLON", "LPAREN", "RPAREN", "LBRACE",
  "RBRACE", "LBRACKET", "RBRACKET", "NUM", "ID", "STRING", "$accept",
...
#line 1183 "parser.tab.c"
  ...
  case 6: /* token: INT  */
#line 71 "parser.y"
          { current_type = "INT_TYPE"; declaration_line = line_num; }
#line 1189 "parser.tab.c"
    break;

  case 7: /* token: FLOAT  */
#line 72 "parser.y"
            { current_type = "REAL_TYPE"; declaration_line = line_num; }
#line 1195 "parser.tab.c"
    break;

  case 8: /* token: CHAR  */
#line 73 "parser.y"
           { current_type = "CHAR_TYPE"; declaration_line = line_num; }
...
#line 87 "parser.y"
        ...
        if (current_type != NULL && !in_function_params) {
            insert_symbol((yyvsp[0].sval), current_type, declaration_line);
        }
    }
