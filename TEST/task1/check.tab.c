...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_CHOICE = 14,                    /* CHOICE  */
  YYSYMBOL_MENU = 15,                      /* MENU  */
  YYSYMBOL_NUM_VAR = 16,                   /* NUM_VAR  */
...
static const char *const yytname[] =
{
  ...
  "INT", "CHAR", "FOR", "IF", "ELSE", "RETURN", "PRINTF", "SCANF", "MAIN",
  "CHOICE", "MENU", "NUM_VAR", "ASSIGN", "LE", "GE", "LESS", "GREATER",
  "EQ", "NE", "AND", "INC", "MUL_ASSIGN", "PLUS", "MINUS", "MUL", "MOD",
  "AMPERSAND", "QUESTION", "COLON", "COMMA", "SEMICOLON", "LPAREN",
